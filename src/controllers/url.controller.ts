...
import {
  CustomSlugShortenerDTO,
  NonCustomSlugShortenerDTO,
...
export const customShorten = async (
  req: Request<{}, {}, CustomSlugShortenerDTO>,
  res: Response,
  next: NextFunction
): Promise<void> => {
  try {
...
export const getPreview = async (
  ...
  res: Response,
  next: NextFunction
): Promise<void> => { // FIX: Syntax error, function body moved to new line
  const { url } = req.body;
